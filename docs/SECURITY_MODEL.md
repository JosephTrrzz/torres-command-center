...
## Website receptionist boundary

The public website receptionist is the only permitted AI feature. It answers from approved knowledge for its configured workspace, falls back to approved text when model inference is unavailable, and supports explicit lead capture and staff handoff. It does not expose the retired internal assistant or grant access to its history. Other AI product features and permissions remain removed.
...
- Rate limits apply to authentication, invitations, website receptionist requests, exports, and provider sync triggers.
