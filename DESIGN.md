...
The customer-facing Private Office may use a low-contrast, repeating security-print pattern built only from the approved wide Torres & Co. Technology wordmark supplied for this purpose. The complete two-line wordmark and its horizontal ornament repeat in staggered rows, rendered in restrained metallic gold over ivory, behind readable content, and at responsive sizes that preserve its proportions. On dark portfolio surfaces, the compact official Torres artwork remains the primary gold emblem. Third-party artwork and literal copies of reference motifs are never used.
