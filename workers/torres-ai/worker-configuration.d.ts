/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c271aa6dcfb1b1cecb60cb6bf5adc441)
...
interface __BaseEnv_Env {
	...
	TorresAiAgent: DurableObjectNamespace<import("./src/index").TorresAiAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TorresAiAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_MODEL" | "AI_GATEWAY_ID" | "TORRES_AI_INTERNAL_SECRET">> {}
}
