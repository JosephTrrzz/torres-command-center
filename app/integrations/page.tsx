...
export default function IntegrationsPage() {
  ...
  return <Shell active="Integrations">
    <div className="page-heading"><div><p className="eyebrow">Data connections</p><h1>Integrations</h1><p className="lede">Organize the proof behind every client website, campaign, and growth recommendation.</p></div><span className="health-badge watch">{selectedClient ? `${readyCount}/${integrations.length} prepared` : "Choose a client"}</span></div>
