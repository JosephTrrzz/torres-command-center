...
type TeamInviteResult = { email: string; role: string; activationLink: string; message: string };
...
export default function SettingsPage() {
  ...
  async function inviteTeam(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setTeamInvite({ email: body.email, role: body.role, activationLink: body.activationLink, message: body.message });
