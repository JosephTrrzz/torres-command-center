...
export default function SettingsPage() {
  ...
  return (
    <Shell active="Settings">
      ...
      <section className="settings-section" id="customer-workspace"><div className="settings-section-head"><div><p className="eyebrow">Customer workspace</p><h2>Make each account feel personal</h2><p>These details shape the customer-facing workspace, report labels, alerts, and explanations.</p></div></div><AccountIdentityEditor /><div className="settings-grid-2">
